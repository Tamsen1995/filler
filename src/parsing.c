...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2016/08/21 18:01:57 by tbui              #+#    #+#             */
/*   Updated: 2016/08/21 18:02:00 by tbui             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		fill_field(t_current *current, char **line, int *tab)
{
	if (tab[1] == 0)
	{
		...
		if ((PLATEAU = (char **)malloc(sizeof(char *) *
			...
			perror("sorry we weren't able to allocate memory");
